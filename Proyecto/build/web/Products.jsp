  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="Category.jsp" class="list-group-item list-group-item-action bg-light">Categorias</a>
        <a href="Products.jsp" class="list-group-item list-group-item-action bg-light">Productos</a>

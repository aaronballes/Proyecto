  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="vendor/Category.jsp" class="list-group-item list-group-item-action bg-light">Categorias</a>
        <a href="vendor/Products.jsp" class="list-group-item list-group-item-action bg-light">Productos</a>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4"> REGISTRAR CATEGORIAS </h1>
      </div>
    </div>
